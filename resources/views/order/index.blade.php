                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-1 px-2">
                            <small class="text-white py-1 px-2 rounded
                                {{$order->checkIsPaid() ? 'bg-emerald-500' : 'bg-gray-400' }} ">
                                {{$order->status}}
                            </small
                            >
                        </td>
                        <td class="py-1 px-2">{{$order->total_price}} Lei</td>
                        <td class="py-1 px-2 whitespace-nowrap">{{$order->items->count()}} produs(e)</td>
                        <td class="py-1 px-2 flex gap-2 w-[100px]">
                            @if (!$order->checkIsPaid())
